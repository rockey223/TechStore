      ...
      <div className="singleProductPage">
        <div className="singleProductWrapper">
          ...
          <div className="singleProductDetails">
            ...
            <div className="singleProductPrice"><FormatPrice price={price}/></div>
            <div className="singleProductDesc">{desc}</div>
            <div className="singleService">

            </div>
            <div className="stars"><Star star={star}/></div>
            <div className="singleProductButtons">
              <button>Buy now</button>
              <button onClick={()=>addToCart(id,img,name,price,qty,quantity)} >Add to cart</button>
            </div>
          </div>
        </div>
      </div>
